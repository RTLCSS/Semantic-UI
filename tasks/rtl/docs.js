...
var
  ...
  // metadata parsing
  metadata     = require('../docs/metadata'),
...
module.exports = function(callback) {
  ...
  console.info('Building Semantic (RTL) for docs ');
  ...
  uncompressedStream
    ...
    .pipe(print(log.created))
    .on('end', function() {
      gulp.start('package uncompressed docs rtl css');
    })
  ;
  ...
  compressedStream
    ...
    .on('end', function() {
      callback();
      gulp.start('package compressed docs rtl css');
    })
  ;
